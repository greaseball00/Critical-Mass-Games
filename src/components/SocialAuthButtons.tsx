...
const providers: {
...
}[] = [
  {
    ...
    hoverColor: 'rgba(66,133,244,0.3)',
    icon: (
  ...
  },
  {
    ...
    hoverColor: 'rgba(88,101,242,0.3)',
    icon: (
  ...
  },
  {
    id: 'twitch',
    label: 'Twitch',
    color: 'rgba(145,71,255,0.15)',
    hoverColor: 'rgba(145,71,255,0.3)',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="#9147FF" xmlns="http://www.w3.org/2000/svg">
      ...
      <div style={{ display: 'flex', gap: '0.6rem' }}>
        {providers.map(p => (
          <button
            ...
            onMouseEnter={e => {
              if (!loadingProvider) (e.currentTarget as HTMLButtonElement).style.background = p.hoverColor;
            }}
            onMouseLeave={e => {
              if (!loadingProvider) (e.currentTarget as HTMLButtonElement).style.background = p.color;
            }}
          >
